...
This software is available under a commercial licence for organisations or individuals who wish to use it for commercial
purposes. Yes, even a simulated power grid requires paperwork.

## When a commercial licence is needed

A commercial licence is needed if you intend to use this software for any of the following:
...
If money changes hands and this software is involved, a commercial licence is needed.

## What a commercial licence provides

A commercial licence grants:

- Permission to use the software in paid and commercial contexts
- The right to modify and extend the software internally
- Permission to run workshops and exercises using the platform
...
Licensing is intentionally lightweight and workshop-friendly. If you are acting in good faith, this process will not be
painful.